...
public class ExcelReport implements ReportType {
	...
	private void initializeTestLogColorPalette() {
		...
		this.testLogAccess.setCustomPaletteColor(10,
				this.reportTheme.getSectionBackColor());
		this.testLogAccess.setCustomPaletteColor(11,
				this.reportTheme.getSectionForeColor());
		this.testLogAccess.setCustomPaletteColor(12,
				this.reportTheme.getContentBackColor());
		this.testLogAccess.setCustomPaletteColor(13,
				this.reportTheme.getContentForeColor());
		this.testLogAccess.setCustomPaletteColor(14, "#008000");
		this.testLogAccess.setCustomPaletteColor(15, "#FF0000");
	...
	public void addTestLogHeading(String heading) {
		...
		this.cellFormatting.setFontSize(12);
		this.cellFormatting.bold = true;
		this.cellFormatting.centred = true;
		this.cellFormatting.setBackColorIndex(8);
		this.cellFormatting.setForeColorIndex(9);
	...
	public void addTestLogSubHeading(String subHeading1, String subHeading2,
		...
		this.cellFormatting.setFontSize(10);
		this.cellFormatting.bold = true;
		this.cellFormatting.centred = false;
		this.cellFormatting.setBackColorIndex(9);
		this.cellFormatting.setForeColorIndex(8);
		this.testLogAccess
	...
	public void addTestLogSection(String section) {
		...
		this.cellFormatting.bold = true;
		this.cellFormatting.centred = false;
		this.cellFormatting.setBackColorIndex(10);
		this.cellFormatting.setForeColorIndex(11);
	...
	public void updateTestLog(String stepNumber, String stepName,
		...
		this.cellFormatting.setFontName("Verdana");
		this.cellFormatting.setFontSize(10);
		this.cellFormatting.setBackColorIndex(12);
		boolean stepContainsScreenshot = this.processStatusColumn(stepStatus);
		this.cellFormatting.centred = true;
		this.cellFormatting.bold = true;
		int columnNum = this.testLogAccess.getColumnNum("Status", 0);
		this.testLogAccess.setValue(rowNum, columnNum, stepStatus.toString(),
				this.cellFormatting);
		this.cellFormatting.setForeColorIndex(13);
		this.cellFormatting.bold = false;
		this.testLogAccess.setValue(rowNum, "Step_No", stepNumber,
				this.cellFormatting);
		this.testLogAccess.setValue(rowNum, "Step_Time", Util
		...
		if (stepContainsScreenshot) {
			if (this.reportSettings.linkScreenshotsToTestLog) {
				...
				this.testLogAccess.setValue(rowNum, "Description",
						stepDescription, this.cellFormatting);
			} else {
				this.testLogAccess.setValue(rowNum, "Description",
						stepDescription + " (Refer screenshot @ "
								+ screenShotName + ")", this.cellFormatting);
			}
		} else {
	...
	private boolean processStatusColumn(Status stepStatus) {
		...
		switch ($SWITCH_TABLE$com$c$f$Status()[stepStatus
				.ordinal()]) {
		case 1:
			this.cellFormatting.setForeColorIndex(15);
			stepContainsScreenshot = this.reportSettings.takeScreenshotFailedStep;
			break;
		case 2:
			this.cellFormatting.setForeColorIndex(16);
			stepContainsScreenshot = this.reportSettings.takeScreenshotFailedStep;
			break;
		case 3:
			this.cellFormatting.setForeColorIndex(14);
			stepContainsScreenshot = this.reportSettings.takeScreenshotPassedStep;
			break;
		case 4:
			this.cellFormatting.setForeColorIndex(17);
		...
		case 5:
			...
			break;
		case 6:
			this.cellFormatting.setForeColorIndex(18);
			stepContainsScreenshot = false;
		}
	...
	private void initializeResultSummaryColorPalette() {
		...
		this.resultSummaryAccess.setCustomPaletteColor(9,
				this.reportTheme.getHeadingForeColor());
		this.resultSummaryAccess.setCustomPaletteColor(10,
				this.reportTheme.getSectionBackColor());
		this.resultSummaryAccess.setCustomPaletteColor(11,
				this.reportTheme.getSectionForeColor());
		this.resultSummaryAccess.setCustomPaletteColor(12,
				this.reportTheme.getContentBackColor());
		this.resultSummaryAccess.setCustomPaletteColor(13,
				this.reportTheme.getContentForeColor());
	...
	public void updateResultSummary(String scenarioName, String testcaseName,
		...
		if (this.reportSettings.linkTestLogsToSummary) {
			this.resultSummaryAccess.setHyperlink(rowNum, columnNum,
					scenarioName + "_" + testcaseName + ".xls");
		}
